"""A small ReAct-style tutoring agent, re-derived here (task-8 branches
...
three-tool shape as Tasks 1/5/6/7, with the same injectable system prompt
Task 7 added, here used so red_team.py can run the guarded system prompt
(guard.build_guarded_system_prompt()) through the identical loop a real
session would use.
"""
